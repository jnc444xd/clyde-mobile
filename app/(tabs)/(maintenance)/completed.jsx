...
import { View, Text, ScrollView, SafeAreaView, Image, RefreshControl, Modal, ImageBackground, TouchableOpacity } from "react-native";
...
const Completed = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setMaintenanceData(completeRequests);
        } catch (error) {
    ...
    const renderSelectedRequestDetails = () => {
        ...
        return (
            <>
                <Text className="text-xl text-black font-pbold my-2">Completed!</Text>
                                        ...
                                        <View key={index} className="flex-row w-full border-gray-300 justify-center">
                                            ...
                                            <View className="flex-1 p-4 text-center text-white bg-gray-800">
                                                {item.isComplete ?
                                                    ...
                                                    >
                                                        <Text className="text-white text-center font-pregular">Press To See Details</Text>
                                                    </TouchableOpacity>
                                                    :
                                                    <TouchableOpacity
                                                        onPress={() => openUpdateModal(item.arrivalWindow, item.arrivalNotes, item.id)}
